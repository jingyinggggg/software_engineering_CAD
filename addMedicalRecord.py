...
class AddMedicalRecordPage:
    ...
    def view(self, page: Page, params: Params, basket: Basket):
        ...
        def addToDatabase(e):
            CreateTable()
            try:
                if (bloodTypeTextField.value != "" and allergiesTextField.value != "" and pastMedicalConditionTextField.value != "" and
                    ...
                    c.execute('INSERT INTO medicalRecordHistory (patientName, patientUserID, bloodType, allergies, '
                              ...
                              'VALUES (?, ?, ?, ?, ?,?, ?, ?, ?, ?)',
                              (
                                  fullName, user_id, bloodTypeTextField.value, allergiesTextField.value, pastMedicalConditionTextField.value,
                                  surgicalHistoryTextField.value, familyMedicalHistoryTextField.value, currentMedicalConditionTextField.value,
