...
class DoctorViewMedicalRecord:
    ...
    def view(self, page: Page, params: Params, basket: Basket):
        ...
        return View(
            "/doctorViewMedicalRecord/:medicalRecord_id",
            controls=[
                Container(width=350,
                          height=700,
                                            ...
                                            content=Row(
                                                controls=[
                                                    Container(
                                                        ...
                                                        on_click=lambda _: page.go(f"/doctorViewMedicalRecordList/{user_id}{patient_id}")
                                                    ),

                                                    Container(
                                                        padding=padding.only(top=25, left=55),
                                                        content=Text(
