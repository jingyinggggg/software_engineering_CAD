...
class EditPrescription:
    ...
    def view(self, page: Page, params: Params, basket: Basket):
        ...
        def update_database():
            c = db.cursor()
            if (medicationName.value != "" and quantityTextField.value != "" and durationTextField.value != "" and
                    instructionTextField.value != ""):
                c.execute("""UPDATE prescriptions SET medicationName = ?, quantity = ?, duration = ?, instructions = ? WHERE 
                prescriptionID = ? """, (medicationName.value, quantityTextField.value, durationTextField.value,
        ...
        submit_dialog = AlertDialog(
            modal=True,
            title=Text("Success"),
            content=Text(f"You have updated the prescription successfully!", text_align=TextAlign.JUSTIFY),
            actions=[
                TextButton("Ok", on_click=lambda _:close_dlg(submit_dialog)),
            ],
        ...
        #     actions=[TextButton("OK", on_click=lambda _:close_dialog())],
        #     actions_alignment=MainAxisAlignment.CENTER,
        #     open=False
        # )
        #
        ...
        error_dialog = AlertDialog(
            ...
            content=Text("Prescription updated failed!",
                         text_align=TextAlign.CENTER),
        ...
        prescription = get_prescription_detail()
        ...
        return View(
            "/editPrescription/:user_id:booking_id:prescription_id",
            controls=[
                Container(
                    width=350,
                    height=700,
                                        ...
                                        content=Row(controls=[
                                            Container(padding=padding.only(left=10, top=5),
                                                      ...
                                                      on_click=lambda _: page.go(
                                                          f"/prescription/{user_id}{booking_id}")
                                                      ),
