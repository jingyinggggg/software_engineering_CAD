...
class PatientChatPage:
    ...
    def view(self, page: Page, params: Params, basket: Basket):
        ...
        def get_doctor_name():
            c = db.cursor()
            c.execute("SELECT fullName FROM doctors WHERE id = ?", (doctor_id,))
            record = c.fetchone()
                ...
                Container(
                    ...
                    content=Row(
                        ...
                        controls=[
                            Column(
                                controls=[
                                    ...
                                    Container(
                                        ...
                                        content=Text(
                                            width=220,
                                            value="Hi, please write down your message here and I'll get back to you "
                                                  "soon...\n(This is an auto generate message)",
                                            size=12,
                            ...
                            CircleAvatar(
                                content=Text(get_initials(doctorName)),
                                color=colors.WHITE,
                                bgcolor=blue
                            ),
                        ]
